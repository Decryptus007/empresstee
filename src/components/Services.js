...
const Services = () => {
  ...
  return (
    <main className="logo-bg relative container mx-auto bg-white">
      ...
      />
      <section className="">
        <div className="p-2 mt-12 h-[450px] flex gap-x-2 items-center justify-between">
          <div
            id="services-head"
            className="w-1/3 px-8 h-full flex flex-col gap-y-6 items-center justify-center text-center text-white"
          >
            ...
            <button
              className={`rounded-full py-2 px-4 font-bold border-[1px] border-white ${
          ...
          <div className="w-2/3 h-full flex gap-x-2 items-center justify-between">
            <div className="w-1/3 h-full flex flex-col gap-y-4">
              <div className="p-4 bg-cyan-100 rounded-lg shadow-lg h-1/2 flex flex-col justify-center gap-y-4">
                <img src={cakeServices} alt="Cake" className="w-1/2" />
                <p className="text-xl font-semibold text-gray-500">Cakes</p>
                <small className="text-md">We bake cake to your taste.</small>
              </div>
              <div className="p-4 bg-yellow-100 rounded-lg shadow-lg h-1/2 flex flex-col justify-center gap-y-4">
                <img src={cupCakeServices} alt="Cake" className="w-1/2" />
                <p className="text-xl font-semibold text-gray-500">CupCake.</p>
                <small className="text-md">We bake cake to your taste.</small>
              </div>
            </div>
            <div className="w-1/3 h-full flex flex-col gap-y-4">
              <div className="p-4 bg-white rounded-lg shadow-lg h-1/2 flex flex-col justify-center gap-y-4">
                <img src={snacksServices} alt="Cake" className="w-1/2" />
                <p className="text-xl font-semibold text-gray-500">Snacks</p>
                <small className="text-md">We bake cake to your taste.</small>
              </div>
              <div className="p-4 bg-pink-100 rounded-lg shadow-lg h-1/2 flex flex-col justify-center gap-y-4">
                <img src={foodServices} alt="Cake" className="w-1/2" />
                <p className="text-xl font-semibold text-gray-500">Foods.</p>
                <small className="text-md">We bake cake to your taste.</small>
              </div>
            </div>
            <div className="w-1/3 h-full flex flex-col gap-y-4">
              <div className="p-4 bg-blue-100 rounded-lg shadow-lg h-1/2 flex flex-col justify-center gap-y-4">
                <img src={eventServices} alt="Cake" className="w-1/2" />
              ...
              <div className="p-4 bg-emerald-100 rounded-lg shadow-lg h-1/2 flex flex-col justify-center gap-y-4">
                <img src={otherServices} alt="Cake" className="w-1/2" />
