  ...
  return (
    <>
      ...
      <main className="relative container mx-auto bg-white">
        <nav className="mx-auto p-4 sticky top-0 left-0 text-white bg-pink-500 w-full flex items-center justify-between">
          <span
          ...
          <NavLink to="about">
            <span className=" md:hidden">
              <FontAwesomeIcon icon="fa-solid fa-heart" className="text-xl" />
            </span>
          </NavLink>
          <div
